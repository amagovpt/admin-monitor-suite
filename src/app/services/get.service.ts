...
export class GetService {
  ...
  getCSVData(): Observable<any> {
    return this.http
      .get<any>(this.config.getServer("/website/csv"), {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  listOfActionLogs(): Observable<any> {
    return this.http
      .get<any>(this.config.getServer("/log/action-log"), {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  listOfDumpFiles(): Observable<any> {
    return this.http
      .get<any>(this.config.getServer("/dump/file-list"), {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  getDumpFile(fileName: string): Observable<any> {
    return this.http
      .get<any>(this.config.getServer("/dump/file/" + fileName), {
        observe: "response",
        responseType: 'blob' as 'json'
      })
      .pipe(
