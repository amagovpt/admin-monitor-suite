...
export class UpdateService {
  ...
  user(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/user/update"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  directory(data: any): Observable<boolean> {
    return this.http
      .post(this.config.getServer("/directory/update"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  tag(data: any): Observable<boolean> {
    return this.http
      .post(this.config.getServer("/tag/update"), data, { observe: "response" })
      .pipe(
        retry(3),
        map((res) => {
          if (!res.body || res.status === 404) {
  ...
  copyTag(data: any): Observable<boolean> {
    ...
    return ajax
      .post(this.config.getServer("/admin/tags/update/copy"), data)
      .pipe(
        retry(3),
        map((res) => {
  ...
  entity(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/entity/update"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  website(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/website/update"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  page(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/page/update"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  importPage(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/page/import"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  importWebsite(data: any): Observable<boolean> {
    return this.http
      .post(this.config.getServer("/website/import"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  importTag(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/tag/import"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
  ...
  evaluationListError(evaluationListId: number): Observable<boolean> {
    return this.http
      .post<any>(
        this.config.getServer("/evaluation/list/tryAgain"),
        { evaluationListId },
        { observe: "response" }
      )
      .pipe(
  ...
  crawlerConfig(data: any): Observable<boolean> {
    return this.http
      .post<any>(this.config.getServer("/crawler/setConfig"), data, {
        observe: "response",
      })
      .pipe(
        retry(3),
